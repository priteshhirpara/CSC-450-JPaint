...
public class ShapeOutline {
    public static class SelectEllipseOutline {
        public static void draw(int startMousePointX,int startMousePointY,int width,int height,double deg,PaintCanvas canvas){
            ...
            transform.rotate(deg, startMousePointX + width / 2, startMousePointY + height / 2);
    ...
    public static class SelectTriangleOutline {
        public static void draw(int xPoints[],int[] yPoints,double deg,PaintCanvas canvas){
            Graphics2D graphics2d=canvas.getGraphics2D();
            Stroke stroke=new BasicStroke(3,BasicStroke.CAP_BUTT,BasicStroke.JOIN_BEVEL,1,new float[]{10},0);
            graphics2d.setStroke(stroke);
            graphics2d.setColor(Color.BLACK);
